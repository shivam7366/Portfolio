          ...
          <div className="col-lg-6 ">
            <div className="frelencer_image">
              ...
              <Fade left duration={500} distance="30px">
                <Image src={man} alt="man" className="f_img_one" />
              </Fade>
              <Fade down duration={500} distance="30px">
                <Image src={cup} alt="man" className="f_img_three" />
              </Fade>
              <Fade down duration={500} distance="30px">
                <Image src={codeshadow} alt="man" className="f_img_four" />
              </Fade>
